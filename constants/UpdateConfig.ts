export const UPDATE_CONFIG = {
  ...
  // GitHub相关URL
  GITHUB_RAW_URL:
    `https://raw.githubusercontent.com/PomeloYolo/DadaTV/master/package.json?t=${Date.now()}`,

  // 获取平台特定的下载URL
  getDownloadUrl(version: string): string {
    return `https://github.com/PomeloYolo/DadaTV/releases/download/v${version}/DadaTV.${version}.apk`;
  },
